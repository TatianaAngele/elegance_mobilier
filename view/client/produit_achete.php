...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="#"> <i class="fa fa-shopping-bag"></i> Produit achété.</a>
                </li>
    ...
    <div>
        <h1 class="text-center">Liste des produits acheté</h1>

        <?php 
            include_once('../../controller/vente/liste_vente_client.php'); 
            $vente->setId_client($_SESSION['id_compte']); 

            $v = $vente->liste_vente_client();
        ?>
                    ...
                    <?php for ($i = 0; $i < count($v); $i++): ?>
                        <div class="col-md-4 mb-4 d-flex">
                            <div class="card h-100"> <!-- Utilisation de h-100 pour garantir que toutes les cartes ont la même hauteur -->
                                <img class="card-img-top" src="../assets/uploads/<?php echo $v[$i]['photo'] ?>" alt="Card image" style="object-fit: cover; height: 200px;">
                                <div class="card-body d-flex flex-column">
                                    <h4 class="card-title"><?php echo $v[$i]['nom_produit'] ?></h4>
                                    <p class="card-text">Prix : <?php echo $v[$i]['prix'] ?></p>
                                    <p>Date de l'achat : <?php 
                                        
                                        // On formate une date MySQL de type JJ-MM-AA
                                        echo DateTime::createFromFormat('Y-m-d', $v[$i]['date_vente'])->format('d/m/Y');
        ...
        <?php else: ?>
            <p class="text-center">Liste de produit acheté vide</p>
        <?php endif; ?>
